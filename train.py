...
class DentConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Car Background + Dents
...
class DentDataset(utils.Dataset):
    ...
    def load_Dent(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            self.add_image(
                "Dents",  ## for a single class just add the name here
